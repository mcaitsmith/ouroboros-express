...
label meters:
    ...
    # guide: [anger_FR1, anger_FR2, bargaining_FR1, bargaining_FR2 including meal reveal, depression_FR1, depression_FR2]
    $ att_num_list_ava = [2,2,2,3,2,2]
    $ dec_num_list_ava = [2,2,2,2,2,2]
    $ att_num_list_darius = [2,2,2,3,2,2]
    $ dec_num_list_darius = [2,2,2,2,2,2]
    $ att_num_list_susurha = [2,2,2,3,2,2]
    $ dec_num_list_susurha = [2,2,2,2,2,2]

    # define decay choice number for each phase (take max of each character)
    $ dec_num_anger = 4
    $ dec_num_bargaining = 4
