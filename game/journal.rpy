label journal:
    ...
    screen journal:
        ...
        if cycle == 0:
            text "{color=#000000}{b}DAY 1{/b}{/color}"  xalign 0.33 yalign 0.1
            text "{color=#000000}[message]{/color}" xalign 0.28 yalign 0.20
        # if len(journal_array) >= 2:
        if cycle == 1:
            # text "{color=#000000}DAY 2{/color}"  xalign 0.25 yalign 0.2
            text "{color=#000000}{b}DAY 2{/b}{/color}"  xalign 0.33 yalign 0.1
        ...
        if cycle == 2:
            ...
            text "{color=#000000}{b}DAY 3{/b}{/color}"  xalign 0.33 yalign 0.1
        ...
        if cycle == 3:
            ...
            text "{color=#000000}{b}DAY 4{/b}{/color}"  xalign 0.33 yalign 0.1
