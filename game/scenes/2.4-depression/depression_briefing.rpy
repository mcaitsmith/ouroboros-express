    ...
    if urshu_story_1 == True and urshu_story_2 == True and urshu_story_3 == True:
        ...
        menu:
            ...
            "Only because I don't trust you to tell it alone.":
                ...
                urshu neutral "Long after you are gone, you will live on. In the old man. In the young girl. In the heart and soul of your family, whose love for you is as undying as the stardust from which you are formed." 
                urshu neutral "In the college romance who still sleeps in your sweater. In the young journalist who remembers your mentorship with every word they write."
